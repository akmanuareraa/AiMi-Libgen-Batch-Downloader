...
#NOTE TO ANYONE TRYING TO MODIFY:
#   * If you want to understand the code you need to understand how the website works
#   * You need to understand how the urls are generated
...
for page in range(1,total_pages+1):
    ...
    for i in range(3, 52, 2):
        ...
        one = soup.find_all('table')[i]

        #getting the link of the particular page
        link = one.find_all('tbody')[0].find_all('tr')[1].find_all('td')[2].find_all('b')[0].find_all('a')[0]

        #getting the format of the file        
        extension = one.find_all('tbody')[0].find_all('tr')[9].find_all('td')[3]
        ...
        extension = str(extension.get_text())
    ...
    for i in range(1,26):
        ...
        #parsing the html page of the link
        r2 = requests.get(download_link_array[i])
        soup2 = BeautifulSoup(r2.content, "html.parser")
        get_link_1 = soup2.find_all('table')[0].find_all('tr')[0].find_all('td')[1].find_all('h2')[0].find_all('a')[0]
        get_link = get_link_1.get('href')
